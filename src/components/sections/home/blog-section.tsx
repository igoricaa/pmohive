...
const BlogSection = ({
  ...
  return (
    <section
      className={cn(
        'py-12 sm:pb-15 sm:mt-8 xl:pb-19 xl:pt-8.5 2xl:pt-16 grid grid-cols-1 md:grid-cols-8 xl:grid-cols-12 gap-6 xl:gap-5',
        className
      )}
    >
      {/* Content Area */}
      ...
      <div className='md:col-span-5 xl:col-span-9 2xl:col-span-8'>
        ...
        >
          ...
          <div className='flex justify-between sm:justify-end items-center gap-3 md:z-10 px-side'>
            <AnimatedButton
              text={ctaButton.text}
              href={ctaButton.link}
              variant={ctaButton.variant as 'default' | 'secondary'}
