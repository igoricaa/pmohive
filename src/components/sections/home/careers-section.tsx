  ...
  return (
    <section className={cn('py-8 md:py-12', className)}>
      <div className='grid grid-cols-1 md:grid-cols-8 xl:grid-cols-12 gap-4 xl:gap-5'>
        {/* Content Area */}
        <div className='md:col-span-4 px-side md:pr-0 flex flex-col md:max-xl:justify-between'>
          <div>
            {/* Subtitle */}
                ...
                >
                  <div className='relative h-full aspect-[285/372] overflow-hidden group'>
                    ...
                    <div className='pl-4 pr-5 xl:pl-8 xl:pr-11 pb-4 xl:pb-7 z-0 h-full flex flex-col justify-end'>
                      ...
                      <div className='mt-2 sm:mt-3 xl:mt-5 z-0 line-clamp-3'>
                        <PortableText
                          value={member.bio as PortableTextBlock[]}
                        />
                      </div>

                      <div className='flex items-center gap-2 xl:gap-3 mt-3 z-0'>
                        <div className='bg-primary rounded-full size-10 xl:size-12.5 flex items-center justify-center shrink-0'>
                          <ArrowRight className='size-5' color='white' />
                        </div>
                        <span className='font-bold sm:text-lg'>Full bio</span>
                      </div>
                    </div>
                  </div>
                </CarouselItem>
