...
const MobileMenu = ({
  ...
  return (
    <div className='xl:hidden'>
      ...
      <div
        className={cn(
          'fixed top-0 right-0 w-full sm:w-130 h-dvh bg-black translate-x-full transition-transform ease-out duration-200 z-30 px-6 sm:px-8 pb-6 sm:pb-8 pt-26 sm:pt-35 flex flex-col justify-between overflow-hidden',
